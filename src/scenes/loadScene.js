...
export class loadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('choose-team', './assets/text/choose-team.png');
        ...
        this.load.image('duos', './assets/modes/duos.png');
        ...
        this.load.image('duos_sel', './assets/modes/duos_selected.png');
